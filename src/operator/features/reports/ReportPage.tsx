...
const ReportPage = () => {
  ...
  const REPORTS: ReportConfig[] = [
    ...
    },
    {
      ...
      endpoint: "/operator/latest-bill/active-users",
      variant: "success",
      exclude: [
        "paymentLink",
        "deleted",
        ...
        "feePrice",
        "consumptionMax",
        "readingsBillDto_currentReading",
        "readingsBillDto_currentReadingDate",
        "readingsBillDto_previousReading",
        "readingsBillDto_idBill",
        "details",
        "surplusChargePerUnit",
        "readingsBillDto_previousReadingDate",
        "idReading",
      ],
      rename: {
        idBill: "Id Factura",
